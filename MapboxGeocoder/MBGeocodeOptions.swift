...
//        }
        if let allowedRegion = allowedRegion {
            ...
            params.append(URLQueryItem(name: "bbox.top", value: "\(allowedRegion.northEast.latitude)"))
            params.append(URLQueryItem(name: "bbox.left", value: "\(allowedRegion.southWest.longitude)"))
            params.append(URLQueryItem(name: "bbox.right", value: "\(allowedRegion.northEast.longitude)"))
            params.append(URLQueryItem(name: "bbox.bottom", value: "\(allowedRegion.southWest.latitude)"))
        }
