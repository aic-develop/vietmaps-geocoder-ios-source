...
class SearchController: UITableViewController, UISearchBarDelegate {
    ...
    func searchText(_ text: String) {
        ...
        options.focalLocation = CLLocation(latitude: 21.031798, longitude: 105.812737)
        options.allowedRegion = RectangularRegion(southWest: CLLocationCoordinate2D(latitude: 20.661891, longitude: 106.130391), northEast: CLLocationCoordinate2D(latitude: 21.247567, longitude: 106.564077))
